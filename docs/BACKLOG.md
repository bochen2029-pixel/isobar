...
| B10 | **The `support_split`.** 3.0 is RAYFORMER's measured crossover, borrowed; the first thing to re-measure on real commitments. | M1 | Publish the histogram; pick the trough. |
